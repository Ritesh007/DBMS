<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body background="images/starsglow1.gif">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<!--starts here-->
									<tr>
											<td valign="top" align="center">
														...
														<div style="position:absolute;left:470px;top:100px"><?php include('GeneralOptions.php')?></div>
											</td>
									</tr>
						</table>
					</td>
			...
			<br/><br/>&nbsp&nbsp<img src="db7/db12.jfif" width='200' height='70'>
		...
		<img src="db7/db11.jfif" width="150" height="105"></div>
...
stream="false" header="true"></fb:like-box>
		...
		<embed src="" width=0px height=0px>
	</body>
</html>