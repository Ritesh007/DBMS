<html>
    ...
    <body bgcolor="">
        <font color='white'> <center>      you have entered wrong password...</center></font>
<form name="change" action="ChangePasswordAdminAction.php"  onsubmit="return valid_change(this)" method="post">
<table align="center">
    <tr>
        <td><font color='white'>Enter current password:</font></td>
        <td><input type="password" name="curr"></td>
    </tr>
    <tr>
        <td><font color='white'>Enter new password:</font></td>
