<html>
 <head>
  ...
  <body bgcolor=""><center><font color="green" size='5'>Edit your detials</font></center>
	<form name="register" action='EditDetailsAction.php' onsubmit='return valid_func(this)' method='post'>
	<table align="center">

		<tr><td><font color='white'>Password</td> <td><input type="password" name="upass"/></td></tr>

		<tr><td><font color='white'>Email id</td> <td><input type="text" name="mail"/></td></tr>

                <tr><td><font color='white'>Address</td> <td><input type="text" name="address" /></td></tr>

		<tr><td><font color='white'>City</td> <td><input type="text" name="city" /></td></tr>

		<tr><td><font color='white'>State</td> <td><input type="text" name="state" /></td></tr>

		<tr><td><font color='white'>Country</td> <td><input type="text" name="country" /></td></tr>

		<tr><td><font color='white'>Ph.No</td> <td><input type="text" name="phno" /></td></tr>
	...
	<table align="center">
        ...
        <center><a href="ViewCustomersPersonal.php"><font color='white'>Personal profile</a></center>
 </body>
</html>